...
def create_base_crosswalk(input_file, output_file):
    ...
    for country in data:
        ...
        if country.get('region'):  # A simple filter for now
            crosswalk.append({
                ...
                'name_short': None,  # To be filled in
                'cow_code': None, # To be filled in
                'wb_code': None, # To be filled in
...
if __name__ == '__main__':
    ...
    create_base_crosswalk(input_file, output_file)
